    ...
    <div class="container">
        ...
        <?php
          foreach($cursor as $document)
         {
          ...
          if($document["Status"]=="1" && $document["Submittedby"]==$_SESSION["uname"] ) {
                ?>
            ...
            <div class="col-md-3 col-sm-6 hero-feature">
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        ...
                        <p>Message From Admin : <?php echo $document["Message"]; ?></p>
                        <p>
        ...
        <?php
          foreach($cursor as $document)
         {
          ...
          if($document["Status"]=="0" && $document["Submittedby"]==$_SESSION["uname"]) {
                ?>
